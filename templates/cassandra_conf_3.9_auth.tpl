...
seed_provider:
    ...
    - class_name: org.apache.cassandra.locator.SimpleSeedProvider
      parameters:
          ...
          # Ex: "<ip1>,<ip2>,<ip3>"
            - seeds: "{% for host in groups[cassandra_group_hosts] %}{{ hostvars[host][cassandra_interface_prod]['ipv4']['address'] }}{%- if not loop.last %},{% endif -%}{% endfor %}"
            #- seeds: "{% for host in groups[cassandra_group_hosts] %}{{ hostvars[host]['cassandra_group_hosts']|default(host) }}{%- if not loop.last %},{% endif -%}{% endfor %}"

...
row_cache_size_in_mb: {{ cassandra_row_cache_size_mb }}
...
seed_provider:
    ...
    - class_name: org.apache.cassandra.locator.SimpleSeedProvider
      parameters:
          ...
          # Ex: "<ip1>,<ip2>,<ip3>"
          - seeds: "{% for host in groups['Cassandra_Cluster'] %}{{ hostvars[host][cassandra_interface_prod]['ipv4']['address'] }}{%- if not loop.last %},{% endif -%}{% endfor %}"
...
server_encryption_options:
    ...
    # algorithm: SunX509
    # store_type: JKS
    cipher_suites: [TLS_RSA_WITH_AES_128_CBC_SHA,TLS_DHE_RSA_WITH_AES_128_CBC_SHA,TLS_DHE_RSA_WITH_AES_256_CBC_SHA,TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA,TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA]
